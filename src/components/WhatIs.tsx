  ...
  return (
    ...
    >
          ...
          <div className={styles.paneInner}>
            ...
            <ul className={styles.list}>
              <li>
                ...
                <span>a task orchestration system</span>
              </li>
              <li>
                <span className={styles.checkMark}>&rarr;</span>
                <span>a safety layer over agent execution</span>
              </li>
              <li>
                <span className={styles.checkMark}>&rarr;</span>
      ...
      <motion.p className={styles.summary} variants={fadeUp}>
        It coordinates agents the same way serious systems coordinate services: with plans, state, events, and rules.
      </motion.p>
    </motion.section>
  )
}
