...
const pillars = [
  { label: 'Clear boundaries', angle: -72 },
  { label: 'Deterministic execution', angle: -36 },
  { label: 'Explicit verification', angle: 0 },
  { label: 'Replayable state', angle: 36 },
  ...
  return (
    ...
    >
      <motion.div className={styles.top} variants={fadeUp}>
        ...
        <p className={styles.lead}>Agents don't fail because they're "not smart enough."</p>
      </motion.div>

      <div className={styles.hub}>
        <motion.div className={styles.center} variants={scaleIn}>
          <span className={styles.centerLabel}>They fail</span>
          <span className={styles.centerSub}>without</span>
        </motion.div>
